...
const Hero = () => {
  ...
  return (
    <div className="relative w-screen overflow-x-hidden h-dvh">
      ...
      <h1 className="absolute z-10 special-font hero-heading bottom-5 right-5" style={{color:"white"}}>
        G<b style={{color:"yellow"}}>A</b>MING
      </h1>
      

      <h1 className="absolute hero-heading bottom-5 right-5" >
        G<b>A</b>MING
      </h1>
